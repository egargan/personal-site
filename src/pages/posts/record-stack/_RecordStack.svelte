<script context="module" lang="ts">
  // Copied here TEMPORARILY until I've fixed Vercel fetching an old version of record-stack from Github that uses enums, leading to Vite transform failures
