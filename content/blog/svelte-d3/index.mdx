...
TODO: de-dupe code between demo components, better naming?<br/>
TODO: rename "whenVisible" to just "showLines"<br/>
TODO: rewrite SSR bit to focus more on doing things "in a more Svelte way"
TODO: upload all code and data to a Gist<br/>
</aside>
...
<script>
  ...
  onMount(() => {
    ...
    const margin = { right: 20, bottom: 20, left: 40 };
